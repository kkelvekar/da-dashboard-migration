...
CREATE TABLE dbo.BusinessEntity (
    ...
    DataDomainSourceConfigId UNIQUEIDENTIFIER NOT NULL, -- FK referencing BusinessEntityConfig
    ...
    CONSTRAINT FK_BusinessEntity_BusinessEntityConfig
        FOREIGN KEY (DataDomainSourceConfigId) REFERENCES dbo.BusinessEntityConfig(Id),
